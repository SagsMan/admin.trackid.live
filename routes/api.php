...
Route::group(['middleware' => ['auth:sanctum', "user.active.check"]], function () {
    ...
    // =============================================
    Route::get('rentals/categories', [App\Http\Controllers\API\RentalController::class, 'categories']);
    Route::get('rentals/{id}/availability', [App\Http\Controllers\API\RentalController::class, 'checkAvailability']);
    Route::apiResource('rentals', App\Http\Controllers\API\RentalController::class);

    Route::get('rental-bookings', [App\Http\Controllers\API\RentalBookingController::class, 'byRenter']);
    Route::post('rental-bookings', [App\Http\Controllers\API\RentalBookingController::class, 'store']);
    Route::get('rental-bookings/{id}', [App\Http\Controllers\API\RentalBookingController::class, 'show']);
    Route::patch('rental-bookings/{id}/status', [App\Http\Controllers\API\RentalBookingController::class, 'updateStatus']);
